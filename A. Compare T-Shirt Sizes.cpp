...
if(a[siz1-1]=='S' && b[siz2-1]=='L')
      cout<<"<\n";
      else if(a[siz1-1]=='L' && b[siz2-1]=='M')
      cout<<">\n";
    else if(a[siz1-1]=='L' && b[siz2-1]=='S')
      cout<<">\n";
      else if(a[siz1-1]=='M' && b[siz2-1]=='L')
      cout<<"<\n";
    else if(a[siz1-1]=='M' && b[siz2-1]=='S')
      cout<<">\n";
       else  if(a[siz1-1]=='S' && b[siz2-1]=='M')
      cout<<"<\n";
    else{
      if(a[siz1-1]!='S'){
      if(c1==c2)
